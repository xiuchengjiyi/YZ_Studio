	...
	<div class="weadmin-body">
		<form id="filmForm" class="layui-form"
			...
			<div class="layui-form-item">
				...
				<input name="film_type" type="hidden" value="2"/>
				<div class="layui-inline">
					<label for="film_name" class="layui-form-label"> <span
						class="we-red">*</span>电视剧名
					</label>
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label for="jishu" class="layui-form-label"> <span
						class="we-red"></span>集数
					</label>
					<div class="layui-input-inline" style="width: 85px">
						<input type="text" id="jishu" name="jishu"  value="${film.jishu }"
							lay-verify="" autocomplete="off" class="layui-input" />
					</div>
				</div>
				<div class="layui-inline">
			...
			<div class="layui-form-item">
				<label for="start_date" class="layui-form-label"> <span
						class="we-red"></span>观看时间段
					</label>
				<div class="layui-inline">
					<div class="layui-input-inline" style="width: 250px">
						<input type="text" id="start_date" name="start_date"  value="${film.start_date }"
							lay-verify="" autocomplete="off" class="layui-input" />
					</div>
				</div>
				-
