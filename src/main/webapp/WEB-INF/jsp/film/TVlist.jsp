		...
		<div class="weadmin-body">
			<div class="layui-row">
				<form class="layui-form layui-col-md12 we-search" onsubmit="return false"> 
					...
					电影名称：
					<div class="layui-inline">
						<input type="text" id="film_name" name="film_name" placeholder="如：亲爱的，热爱的" class="layui-input"  autocomplete="off">
					</div>
					主演：
					<div class="layui-inline">
				...
				table.on('tool(TVTable)',function(obj){ //movieTable为table的lay-filter
					...
					if(layEvent == 'update'){
						var index = layer.open({
							type : 2,
				            content : 'addTV?film_id='+data.film_id,
				            area : [ '900px', '730px' ],
				            maxmin : true,
				            title : '更新电影',
